...
TRUE_DATA_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "project-2-intelligent-rag", "zyro-dynamics-hr-corpus")
NOISY_DATA_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "project-2-intelligent-rag", "noisy_data")
NOISY_ALLOWED_EXTS = {".pptx", ".docx", ".txt", ".pdf"}
